...
def load():
    global CloudcoreFL
    with open("CloudcoreFL", "r",encoding="utf-8") as f:
        CloudcoreFL = json.load(f)


def save():
    global CloudcoreFL
    with open("CloudcoreFL", "w", encoding="utf-8") as nocayt:
        json.dump(CloudcoreFL, nocayt)
    ...
    while True:
        ...
        if menu == "/akvadevida":
            ...
            if ligovapyt == "список":
                ...
                print("Деревянная I [600 трофеев]")
